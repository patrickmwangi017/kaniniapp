...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
           ...
           @else
                 <!-- logo for regular state and mobile devices -->
           <span class="logo-lg">Kanini Haraka Enterprises Shipment Manager</b></span>
           <!-- <img src="images/favicon.png" class="img-circle" alt=""> -->
           @endif
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <div class="pull-left">
                                        <a href="{{URL::to('shipmentmanagerprofile')}}" class="btn btn-default btn-flat"> <i class="fa fa-user"></i>Manage Profile</a>
                                    </div>

                                    <div class="pull-right">
                                        <a href="{{URL::to('shipmentmanagerlogout')}}" class="btn btn-default btn-flat"> <i class="fa fa-sign-out"></i> Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
...
<ul class="sidebar-menu" data-widget="tree">
                <!-- <li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('shipmentmanagerprofile')}}"><i class="fa fa-clone"></i> Update Profile</a></li>
                    ...
                    <!-- <li class="treeview">
                        <a href="#">
                            <i class="fa fa-tint"></i>
                            <span> Manage Service Deliveries</span>
                            <span class="pull-right-container">
                            </span>
                        </a>
                        <ul class="treeview-menu">
                        <li><a href="{{URL::to('shipmentmanagerallbookings')}}"><i class="fa fa-clone"></i> All Bookings</a></li>
                            <li><a href="{{URL::to('shipmentmanagerpendingbookings')}}"><i class="fa fa-money"></i>Bookings Pending Allocation</a></li>
                            <li><a href="{{URL::to('shipmentmanagerallocatedbookings')}}"><i class="fa fa-money"></i> Allocated Bookings</a></li>
                        </ul>
                    </li> -->

                    <li>
                        <a href="{{URL::to('shipmentmanager/shipmentreport')}}">
                        <i class="fa fa-tint"></i>
                        <span>Generate Shipment Report</span>
                        <span class="pull-right-container">
                        </span>
                    </a>
                    </li>
                    ...
                    <li>
                        <a href="{{URL::to('shipmentmanagerlogout')}}">
